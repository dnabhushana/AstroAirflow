...
default_args={
    "owner": "ARJUN DN,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2023-12-01", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "ARJUN DN": "mailto:dnabhushana@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clpm7q93h003j01je35wjiktw/cloud-ide/clpm7tbny003j01k29avsxovr/clpm7tc4x000o01fhlwo9oe38",
    },
)
